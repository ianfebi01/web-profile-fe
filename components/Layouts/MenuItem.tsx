              ...
              >
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5">
                  ...
                  <div className="bg-dark p-4">
                    <a
                      href="##"
                      className="flow-root rounded-md px-2 py-2 transition duration-150 ease-in-out hover:bg-dark-secondary focus:outline-none focus-visible:ring focus-visible:ring-orange-500/50"
                    >
